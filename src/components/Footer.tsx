    ...
    <footer id="iys-footer" className="relative overflow-hidden border-t border-[#b86d4a]/25 bg-[#f5eadb] px-4 pb-8 pt-16 text-[#50362a] sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-["Cormorant_Garamond",serif] text-2xl font-semibold uppercase tracking-[0.12em] text-[#50362a] leading-none">
                Ishwari
              </h3>
              <span className="mt-1 block text-[10px] font-semibold uppercase tracking-[0.26em] text-[#b86d4a]">
                Yoga Institute
              </span>
            </div>
          </div>

          <p className="max-w-sm text-sm leading-relaxed text-[#5f4a41]">
          ...
          <div className="flex items-center gap-3 pt-1">
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-[#b86d4a]/20 bg-[#fffaf4] text-[#50362a] shadow-sm transition-all duration-300 hover:border-[#b86d4a] hover:text-[#b86d4a]"
            >
              <Youtube size={16} />
            </a>
            <a
            ...
            <a
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full border border-[#b86d4a]/20 bg-[#fffaf4] text-[#50362a] shadow-sm transition-all duration-300 hover:border-[#687454] hover:text-[#687454]"
            >
        ...
        <div>
          <h4 className="mb-6 border-b border-[#b86d4a]/20 pb-2 font-["Cormorant_Garamond",serif] text-lg font-semibold uppercase tracking-[0.12em] text-[#50362a]">
            Institute Links
          </h4>
            ...
            {[
              ...
              <li key={link.id}>
                <button
                  ...
                  className="group flex items-center gap-2 text-left text-[#5f4a41] transition-colors hover:text-[#687454]"
                >
                  <span className="h-1.5 w-1.5 rounded-full bg-[#b86d4a] opacity-0 transition-opacity group-hover:opacity-100" />
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-[#5f4a41]">
            <li className="flex items-start gap-3">
              <MapPin size={18} className="mt-0.5 shrink-0 text-[#687454]" />
              <span>
                <strong className="font-semibold text-[#50362a]">Main Campus:</strong><br />
            ...
            <li className="flex items-center gap-3">
              <Phone size={16} className="shrink-0 text-[#687454]" />
              <span>+91 8208368237 / +91 9607517375</span>
            </li>
            <li className="flex items-center gap-3">
              <Mail size={16} className="shrink-0 text-[#687454]" />
              <a href="mailto:Devikabhide8@gmail.com" className="transition-colors hover:text-[#687454]">
        ...
        <div>
          ...
          <div className="h-48 overflow-hidden rounded-[1.25rem] border border-[#b86d4a]/20 bg-[#fffaf4] shadow-sm">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3782.3387766579365!2d73.91264857601723!3d18.560940568019313!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c147b4e7f1ac%3A0x686d7d6a6d2d6d3c!2sIshwari%20Yoga%20Institute!5e0!3m2!1sen!2sin!4v1710000000000!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0, filter: 'grayscale(0.2) sepia(0.12) contrast(0.96)' }}
          ...
          <p className="mt-3 text-center text-[11px] text-[#5f4a41]">
      ...
      <div className="relative z-10 mx-auto mt-16 flex max-w-7xl flex-col items-center justify-between gap-4 border-t border-[#b86d4a]/20 pt-8 text-center text-xs text-[#5f4a41] sm:flex-row sm:text-left">
        ...
        <p className="flex items-center gap-1.5">
          Made with reverence for Yoga Shastra & Indian Heritage
          <Heart size={10} className="fill-[#b86d4a] text-[#b86d4a]" />
        </p>
      </div>
    </footer>
  );
